...
public class ShiroConfig {
    ...
    public static final int ITERATES = 2;
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        // 散列的次数
        hashedCredentialsMatcher.setHashIterations(ITERATES);
        // storedCredentialsHexEncoded默认是true，此时用的是密码，加密用的是Hex编码；false时用Base64编码
